...
- Direct: https://github.com/aquamammal/ichnaea-android/raw/main/dist/ichnaea-android-v0.2.14-debug.apk
- SHA-256: `48f98d80dd634179b501ee2d470f8d89776f0644ec8d5f977fd16b370223267d`
...
> ```bash
> npm run build:apk
> cp android/app/build/outputs/apk/debug/app-debug.apk dist/ichnaea-android-v0.2.14-debug.apk
> sha256sum dist/ichnaea-android-v0.2.14-debug.apk   # update the SHA-256 above
> ```
>
...
>
> ```bash
> gh release create v0.2.14 dist/ichnaea-android-v0.2.14-debug.apk --title "Ichnaea Android v0.2.14"
> ```
>
